  ...
  return (
    <div className='w-3/4 h-[80vh] bg-white p-0 rounded-xl shadow-lg relative overflow-hidden'>
      ...
      <div className='w-full h-20 bg-blue-800/90 rounded-tl-xl rounded-tr-xl p-5 relative'>
        ...
        <h1 className='text-2xl font-bold text-white'>Availability and Price</h1>
      </div>

      {/* Vertically scrollable content */}
      <div className='h-[calc(100%-5rem)] overflow-y-auto overflow-x-hidden p-5'>
          {/* Block Table */}
          <p><span className='text-red-900'>*</span> Select the block and click on the flat no. to know Price and Availability</p>
                ...
                <tr className=''>
                  {['Block 1', 'Block 2', 'Block 3', 'Block 4', 'Block 5', 'Block 6','Block 1', 'Block 2', 'Block 3', 'Block 4', 'Block 5', 'Block 6'].map((block, index) => (
                    <td key={index} className='p-3'>
                      <button
                        className='transition delay-10 duration-300 ease-in-out hover:-translate-y-1 hover:scale-100 w-full h-full bg-white/80 text-black font-bold rounded-xl border-2 border-black p-4 hover:bg-green-400 cursor-pointer'
          ...
          <div className="overflow-x-auto rounded-xl shadow-lg">
           <div className='flex flex-col w-full items-center justify-center h-auto bg-blue-900 pt-2 pb-2'>
              <h1 className='font-bold text-3xl text-white'>  {blockName}</h1>
           </div>
            <table className="min-w-max w-full border-collapse bg-white text-gray-800">
                ...
                <tr>
                  ...
                  {Array(4).fill().map((_, i) => (
                    <th key={i} className="py-4 px-6 text-center">
                      <p className="font-semibold text-lg">3 BHK</p>
              ...
              <tbody>
                <tr className="odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-100 transition-colors">
                  <th className="py-3 px-6 text-left font-medium text-gray-700">1st</th>
                  {['A01', 'A02', 'A03', 'A04'].map((flat, i) => (
                    <td key={i} className="py-3 px-6 text-center font-medium cursor-pointer hover:bg-blue-200 rounded-lg">
                      <button onClick={() => toggleFLatprice(flat)}>{flat}</button>
                    </td>
                  ))}
                </tr>
                <tr className="odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-100 transition-colors">
                  <th className="py-3 px-6 text-left font-medium text-gray-700">2nd</th>
                ...
                <tr className="odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-100 transition-colors">
                  <th className="py-3 px-6 text-left font-medium text-gray-700">3rd</th>
                ...
                <tr className="odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-100 transition-colors">
                  <th className="py-3 px-6 text-left font-medium text-gray-700">4th</th>
                ...
                <tr className="odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-100 transition-colors">
                  <th className="py-3 px-6 text-left font-medium text-gray-700">5th</th>
                ...
                <tr className="odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-100 transition-colors">
                  <th className="py-3 px-6 text-left font-medium text-gray-700">6th</th>
                ...
                <tr className="odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-100 transition-colors">
                  <th className="py-3 px-6 text-left font-medium text-gray-700">7th</th>
                ...
                <tr className="odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-100 transition-colors">
                  <th className="py-3 px-6 text-left font-medium text-gray-700">8th</th>
                ...
                <tr className="odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-100 transition-colors">
                  <th className="py-3 px-6 text-left font-medium text-gray-700">9th</th>
