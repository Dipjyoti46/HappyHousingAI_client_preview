...
const Calculators = () => {
  return (
    <div className='flex flex-col items-center w-full min-h-[400px] bg-black/10 backdrop-blur-md mb-0'>
        <div className='w-full'>
            <h1 className='text-white text-2xl md:text-4xl font-bold ml-5 mt-10'>Calculators</h1>
        </div>
